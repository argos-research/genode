...
void prepare_init_main_thread()
{
	...
	PLOG("[cap_cr][thread_bootstrap.cc::prepare_init_main_thread]");
	Genode::raw("[cap_cr][thread_bootstrap.cc::prepare_init_main_thread] Inserting MAIN_THREAD_CAP (", Hex(THREAD_CAP_ID), ", ", Hex(Fiasco::MAIN_THREAD_CAP), ")");
	Genode::raw("cap_cr|STAGE|prepare_init_main_thread|");
